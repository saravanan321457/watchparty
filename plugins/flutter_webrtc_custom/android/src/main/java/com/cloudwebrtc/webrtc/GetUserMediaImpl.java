...
public class GetUserMediaImpl {
    ...
    private Pair<String, VideoCapturer> createVideoCapturer(
        ...
        VideoCapturer videoCapturer = null; if (sourceId != null && sourceId.startsWith("MP4_VIDEO:")) { return new Pair<>(sourceId, new com.cloudwebrtc.webrtc.Mp4Capturer(sourceId.substring(10))); }
    ...
    private ConstraintsMap getUserVideo(ConstraintsMap constraints, MediaStream mediaStream) {
        ...
        // Mp4Capturer is not a real camera — skip the Camera2 "opened" wait.
        if (!(videoCapturer instanceof Mp4Capturer)) {
    ...
    void removeVideoCapturer(String id) {
        ...
        if (newPrimaryId != null) {
            ...
            try {
                ...
                if (info.cameraEventsHandler != null && !(info.capturer instanceof Mp4Capturer)) {
